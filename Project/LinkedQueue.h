...
/* Type definitions */
typedef struct element{//added element, was it needed since its also below
	int itemCode; 	/* stores a number describing the element */
	int obj; 	/* 0:black 1:aluminum 2:white 3:steel*/
} element;// what is the need of this? declares element with element?
